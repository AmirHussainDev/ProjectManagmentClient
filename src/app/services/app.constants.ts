...
export const PermissionName = {
    ...
    [AppPermissions.AddTask]: "Add Task",
    [AppPermissions.UpdateTask]: "Upate Task",
    ...
    [AppPermissions.AddTaskWorklog]: "Update Task Worklog",
